 ...
 *
 * Custom error classes and error handling helpers for Shippo API.
 */

/**
 * Base Shippo API error
 */
 ...
 */
export class RateLimitError extends ShippoApiError {
 ...
 */
export class AuthenticationError extends ShippoApiError {
 ...
 * Not found error
 */
export class NotFoundError extends ShippoApiError {
 ...
 * Validation error
 */
export class ValidationError extends ShippoApiError {
